            ...
            <div className="blogpage">
                <div className="titledashboard flex flex-sb">
                    <div data-aos="fade-right">
                        <h2>All Published<span> Photo</span></h2>
                        <h3>ADMIN PANEL</h3>
                    </div>
                    <div className="breadcrumb" data-aos="fade-left">
                        <BsPostcard /> <span>/</span><span>Photos</span>
                    </div>
                </div>
                        ...
                        <tbody data-aos="fade-up">
                            {loading ? <>
                                ...
                                {currentBlogs.length === 0 ? (
                                    <tr>
                                        <td colSpan="4" className="text-center">No Photo Available</td>
                                    </tr>
                                ) : (
                                        ...
                                        <tr key={blog._id} >
                                            ...
                                            <td>
                                                <div className='flex gap-2 flex-center'>
                                                    <Link href={'/gallery/edit/' + blog._id}><button title='edit'><FaEdit />Edit</button></Link>
                                                    <Link href={'/gallery/delete/' + blog._id}><button title='delete'><RiDeleteBin6Fill />Delete</button></Link>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
