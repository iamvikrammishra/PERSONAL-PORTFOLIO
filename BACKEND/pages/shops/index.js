            ...
            <div className="blogpage">
                <div className="titledashboard flex flex-sb">
                    ...
                    <div className="breadcrumb" data-aos="fade-left">
                        <BsPostcard /> <span>/</span><span>Projects</span>
                    </div>
                </div>
                        ...
                        <tbody data-aos="fade-up">
                            {loading ? <>
                                ...
                                {publishedblogs.length === 0 ? (
                                    <tr>
                                        <td colSpan="4" className="text-center">No Project Available</td>
                                    </tr>
                                ) : (
                                        ...
                                        <tr key={blog._id} >
                                            ...
                                            <td>
                                                <div className='flex gap-2 flex-center'>
                                                    <Link href={'/shops/edit/' + blog._id}><button title='edit'><FaEdit />Edit</button></Link>
                                                    <Link href={'/shops/delete/' + blog._id}><button title='delete'><RiDeleteBin6Fill />Delete</button></Link>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
